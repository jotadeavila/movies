...
// console.log(movies)
  ...
  return (
    <Container>
      ...
      <div className="hero">
        <img src={backgroundHome} alt="fondo" className='background-image' />
        <div className="container">
          <div className="logo">
            <img src={homeTitle} alt="Logo" />
          </div>
          <div className="buttons flex">
            <button className='flex j-center a-center' onClick={() => navigate('/player')}><FaPlay />Play</button>
            <button className='flex j-center a-center'><AiOutlineInfoCircle />Más Info</button>
          </div>
        </div>
      </div>
